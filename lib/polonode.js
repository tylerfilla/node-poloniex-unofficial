...
/*
 * Module IDs for wrappers and utilities.
 */
const MOD_ID_WRAPPER_PUSH = "./api/PushWrapper.js";
const MOD_ID_WRAPPER_PUBLIC = "./api/PublicWrapper.js";
const MOD_ID_WRAPPER_TRADING = "./api/TradingWrapper.js";
const MOD_ID_UTIL_CURRENCY_PAIR = "./util/CurrencyPair.js";
const MOD_ID_UTIL_ORDER_BOOK = "./util/OrderBook.js";
 ...
 */
exports.CurrencyPair = require(MOD_ID_UTIL_CURRENCY_PAIR);

/*
 * Order book utility constructor.
 */
exports.OrderBook = require(MOD_ID_UTIL_ORDER_BOOK);
