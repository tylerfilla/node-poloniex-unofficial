...
const DEFAULT_UPDATE_BUFFER_SIZE = 5;
...
OrderBook.prototype._bufferUpdate = function(update) {
    // Remove buffered obsolete updates
...
OrderBook.prototype._handleUpdate = function(update) {
    console.log("handle: " + update.seq + " (buffered: " + this._updateBuffer.length + ")");
