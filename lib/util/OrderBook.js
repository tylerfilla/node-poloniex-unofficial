...
const CurrencyPair = require("./CurrencyPair.js");
const PushWrapper = require("./../api/PushWrapper.js");
const PublicWrapper = require("./../api/PublicWrapper.js");
...
function OrderBook(currencyPair) {
    ...
    if (this._currencyPair instanceof CurrencyPair) {
        this._currencyPair = this._currencyPair.toString();
    }
}
